...
### macOS
1. Unzip the downloaded file.
2. Open the resulting folder.
3. Drag the `crepl` app to your Applications folder.
...
## 🛠️ Using crepl
Once you have installed crepl, you are ready to start coding in C. 

### Writing Code
- Open the crepl application.
- You will see a prompt waiting for your input. Type any C code you want to run.

### Running Code
- After typing your code, press `Enter`.
- The result will appear immediately, allowing you to see the outcome of your code.

## 🌟 Features
- **Interactive Environment:** Instantly run C code and see results.
- **Syntax Highlighting:** Easy to read your code.
- **Error Messages:** Understand problems quickly with clear error messages.
...
### Can I use crepl for learning C?
Yes, crepl is a great tool for beginners to learn the basics of C programming.

### Is crepl free to use?
Absolutely! crepl is open-source and completely free.
